                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-6">
                            <h3 class="mb-0">Data Pompa Air</h3>
                        </div>
                        <div class="col-md-6 col-6 text-right">
                          <a href="{{ route('administrator.waterpump.create')}}" class="btn btn-sm btn-primary">
                    ...
                    <table class="table align-items-center table-flush table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">Lokasi Terpasang</th>
                                    ...
                                    <div class="modal fade" id="editModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-secondary py-0">
                                                <form action="{{route('administrator.waterpump.update', ['id' => $data->id])}}" method="post">
                                                    @csrf
                                                    @method("PATCH")
                                                    @include('administrator.waterPump.partials.form')
                                            </div>
